...
$.ajax({
    ...
    .then(function(response) {
        ...
        queryURL2 = "https://developers.zomato.com/api/v2.1/search?q=" + restaurantName + "&count=15&lat=" + lat + "&lon=" + lon + "&radius=24140.2&cuisine=" + cuisine + "&category=takeaway";
        if ((restaurantName == true) || (cuisine == true)) {
            queryURL2 = "https://developers.zomato.com/api/v2.1/search?q=" + restaurantName + "&count=15&lat=" + lat + "&lon=" + lon + "&radius=24140.2&cuisine=" + cuisine;
        ...
        //         console.log(responseZomato.restaurants[7].restaurant.location.latitude);
        //         console.log(responseZomato.restaurants[7].restaurant.location.longitude);
        ...
        //         for (var i = 0; i < responseZomato.restaurants.length - 1; i++); {
        ...
        //         console.log(restaurantLoc);
                ...
                // var marker, i;
                //     for (i = 0; i < restaurantLoc.length; i++); {
                //         marker = google.maps.marker({
                //             position: new google.maps.LatLng(restaurantLoc[i][1], location[i][2]),
                //             map: map
                //         });
                //     }
